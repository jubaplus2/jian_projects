...
for file in list_all_weekly_data:
    ...
    df_order_this_week_rewards=pd.merge(df_order_this_week_rewards,df_id_order_count,on='customer_id_hashed',how="outer")
    ...
    #
    df_order_this_week_rewards=df_order_this_week_rewards[['customer_id_hashed','trans_order_since_18Q1']].sort_values("trans_order_since_18Q1",ascending=False).drop_duplicates("customer_id_hashed")
