...
df_defile_file=pd.read_csv("./Quarterly_Decile_Detail/df_detail_"+str(audience_year)+"Q"+str(audience_Quarter_num)+".csv",
...
writer_folder_quarter="./output_no_shopping/Q"+str(audience_Quarter_num)+"_"+str(audience_year)+"/"
