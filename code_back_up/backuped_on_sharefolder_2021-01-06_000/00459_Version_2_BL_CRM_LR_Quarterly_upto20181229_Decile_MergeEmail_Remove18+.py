...
folder_write = '/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/output/Version2_upto20181229_Decile_MergeEmail_Remove18+_'+str(datetime.datetime.now().date())+'/'
try:
