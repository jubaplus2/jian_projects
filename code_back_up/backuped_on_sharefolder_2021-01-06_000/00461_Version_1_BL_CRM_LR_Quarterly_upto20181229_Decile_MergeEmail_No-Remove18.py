...
import gc
import glob
logging.basicConfig(filename='Version_1_BL_CRM_LR_Quarterly_upto20181229_Decile_MergeEmail_No-Remove18.log', level=logging.INFO)
...
folder_write = '/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/output/Version1_upto20181229_Decile_MergeEmail_NoRemove_'+str(datetime.datetime.now().date())+'/'
try:
...
all_rewards_since_201606.to_csv("/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/BL_Rewards_Transactions_20160626_to_20181229.csv")
gc.collect()
