...
import gc
import glob
logging.basicConfig(filename='Version_4_BL_CRM_LR_Quarterly_upto20190330_MergeEmail_Decile_NoRemove.log', level=logging.INFO)
...
folder_write = '/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/output/Version4_upto20190330_MergeEmail_Decile_NoRemove_'+str(datetime.datetime.now().date())+'/'
try:
