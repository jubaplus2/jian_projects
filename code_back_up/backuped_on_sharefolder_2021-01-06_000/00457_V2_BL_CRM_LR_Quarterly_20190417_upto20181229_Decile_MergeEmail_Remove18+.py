...
import gc
import glob
logging.basicConfig(filename='V2_BL_CRM_LR_Quarterly_20190418_upto20181229_Decile_MergeEmail_Remove18+.log', level=logging.INFO)
...
folder_write = '/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/output_upto20181229_Decile_MergeEmail_Remove_'+str(datetime.datetime.now().date())+'/'
try:
