...
df=pd.read_csv("/Users/jubaplus/Desktop/IT-HH-ViewershipDayPartsNew.csv",sep="\t",dtype={'Episode Name':'object'})
df.columns
'''
test=df[['Program Code','Program Name','Episode Name']]
test=test.drop_duplicates()
test.to_csv('/Users/jubaplus/Desktop/Epnames2.csv',index=False)
'''
test=pd.read_csv('/Users/jubaplus/Desktop/Epnames.csv',dtype={'Episode Name':'object'})
df=pd.merge(df,test,on=['Program Code','Program Name','Episode Name'])
df['Program Name']=df['NewProgramName']
df['Program Code']=df['NewProgramID']
...
hhintab.to_csv("/Users/jubaplus/Desktop/showaffinitysund2.csv",index=False)
