...
import logging
logging.basicConfig(filename='demologs_150201_170402.log', level=logging.INFO)
...
####output path
filepath='/home/nielsen/MicroSegment/Outputs/Demo/Demographicpersonlevel_150201_170402.csv'
...
for i in names2024:
    ...
    type20=type20.sort_values('LastUpdateDate',ascending=False)
...
for i in names65:
    ...
    type65=type65.sort_values('ReportWeek65',ascending=False)
