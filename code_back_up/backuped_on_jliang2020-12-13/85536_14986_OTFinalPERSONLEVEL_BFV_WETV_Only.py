...
"""
import logging
logging.basicConfig(filename='log_bfv_WETV_otlogs.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/BFV6/WETV/'
...
itlist=['0343256','0424948','0354751','0385186']
balance_cluster=[3]
