...
"""
import logging
logging.basicConfig(filename='log_goodfood_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Zliving/goodfood/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/Zliving/goodfood_cluster.csv'
