...
"""
import logging
logging.basicConfig(filename='log_charge_cable_Show.log', level=logging.INFO)
logging.info('otlogcharge')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/MGM/Charge/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/MGM/Charge_cluster.csv'
