...
foldername='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/Sizing'
...
quadspath=''
viewershippath=''
itshowpath='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/guhhatl2_showaffinity_cluster.csv'
otshowpath='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/OT/Cable/programmin.csv'
bcastotindicator='T'
otshowpath1 = ['/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/OT/Broadcast/programmin.csv']

ga1='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/Sizing/GUHHATL_BFV_GUHH_L12M.csv'
ga3='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/Sizing/BWIVES_BLACKINK_MODEL_L12M.csv'
ga5='/Users/jubaplus1/Desktop/WETV 2018/WETV_GUHH ATL 2/Sizing/wetv_l12m_1001.csv'
...
###otshownames:
#otshowpath1
otshownames1=['CW   _ROBERT IRVINE SHOW       ','FOX  _EMPIRE                   ','ABC  _SCANDAL                  ']
#otshowpath2
otshownames2=['VH1  _T.I. AND TINY 6          ','VH1  _BLACK INK CREW CHICAGO 3 ','FUSE _MOESHA                   ','VH1  _MY WIFE AND KIDS         ','OWN  _IYANLA, FIX MY LIFE      ','OWN  _IF LOVING YOU IS WRONG   ','VH1  _JAMIE FOXX SHOW          ','BRVO _VANDERPUMP RULES         ','LIF  _LITTLE WOMEN ATL         ','VH1  _DAYTIME DIVAS            ','VH1  _BALLER WIVES             ','BRVO _THEN AND NOW W/ANDY COHEN']
#otshowpath3
otshownames3=['']
#otshowpath4
otshownames4=['']
...
df.to_csv("AudienceSizing_guhhatls2_100.csv",index=False)
print(datetime.datetime.now())
