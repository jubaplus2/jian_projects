...
"""
import logging
logging.basicConfig(filename='campbells_a.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0422483','0394862']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/campbells_a.csv'
