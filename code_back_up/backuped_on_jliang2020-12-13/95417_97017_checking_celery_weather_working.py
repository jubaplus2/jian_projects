...
BL_daily_weather_file_list = glob.glob("/home/jian/Projects/Big_Lots/Weather/Json_data/daily/"+today_str+"*.json")
BL_forecast_weather_file_list = glob.glob("/home/jian/Projects/Big_Lots/Weather/Json_data/forecast/"+today_str+"*.json")
...
if (len(BL_daily_weather_file_list)==3) & (len(BL_forecast_weather_file_list)==3) & (len(SK_daily_weather_file_list)==0) & (len(SK_forecast_weather_file_list)==0):
