...
class EtlPos:
    ...
    def __init__(self):
        ...
        self.table_filtered_pos = "pred_pos_dept_withDCM_pos_from_20180204_to_20200118"
        self.table_filtered_crm = "crm_withDCM_pos_from_20180204_to_20200118"
        self.table_max_trans_order = "pos_id_max_trans_order_withDCM_pos_from_20180204_to_20200118"
        self.table_2_1 = ""
        self.table_2_2 = ""
        # MySQL validator
        self.record = {}
    ...
    def preprocess(self):
        ...
        def get_max_trans_order_for_each_id():
            self.table_max_trans_order = self.generate_table_name(prefix="pos_id_max_trans_order")
    ...
    def build_table_2_1(self):
        ...
        self.table_2_1 = self.generate_table_name(prefix="sample", table_name="pred_pos_2_1") if not \
    ...
    FLOOR(DATEDIFF('2019-08-31', MIN(crm.sign_up_date))/7) AS week_diff, \
    ...
    COUNT(DISTINCT (CASE WHEN t.location_id = 6990 THEN t.trans_order_since_18Q1 ELSE 0 END)) AS trans_online,"
    ...
    def build_table_2_2(self):
        def build_all_views():
            ...
            build_view_of_recent_one_to_five_transaction()
            return
        ...
        def build_view_of_recent_one_to_five_transaction():
            all_view_query = [generate_view_of_recent_week_n_transaction(i + 1) for i in range(5)]
        ...
        ANY_VALUE(CEILING(DATEDIFF('2019-08-31', p.transaction_dt)/7)) AS week_counts_to_now_%s, \
        ...
        self.table_2_2 = self.generate_table_name(prefix="sample", table_name="pred_pos_2_2") if not \
    ...
    def generate_table_name(self, prefix="", table_name="", source_table_name="", is_from_source=False):
        ...
        result = "withDCM" + result if self.is_with_dcm else "random" + result
