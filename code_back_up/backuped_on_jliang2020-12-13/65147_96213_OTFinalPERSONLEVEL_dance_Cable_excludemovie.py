...
"""
import logging
logging.basicConfig(filename='log_dance_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/DanceMom/Cable'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/DanceMom/dance_IT_showaffnity_cluster.csv'
...
itlist=['0288526','0366428','0345570','0373522','0420782','0320916','0353846','0404360','0337744','0410223','0410187']
balance_cluster=[3]
occasional_cluster=[7]
...
###change Cable ID###
excludecableid=['006218','008908','008336','006196','008338']
...
allfile=allfile[~allfile['CableID'].isin(excludecableid)]
