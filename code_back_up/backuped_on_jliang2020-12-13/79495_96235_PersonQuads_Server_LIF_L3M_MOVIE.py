...
"""
import logging
logging.basicConfig(filename='lif_l3m_movie.log', level=logging.INFO)
...
##### update Cable ID (WeTV: '007516',SUND: '007602',STARZ: '009157', WGNA: '006788', aen: '006218')
Cable_ID='006196'

##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/lif_l3m_movie.csv'
...
type30['programtypecode']=type30['all'].str[122:126]
type30['programtypecode'] = type30['programtypecode'].str.strip()
type30 = type30[type30['programtypecode']=='FF']

type30 = type30[type30['Weekday']>=5]
...
allfile['mins']=allfile['ViewEndTime']-allfile['ViewStartTime'] + 1
