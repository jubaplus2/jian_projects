...
Cable_ID=['006198','006201']

##### update the outputs path and location
rawfiledic='/Users/jubaplus1/Desktop/MTVFRMQuads1.csv'
...
allfile=allfile[['HHID', 'CableID', 'ViewDate', 'PersonID','Age',
...
allfile.to_csv(rawfiledic,index=False)

del (i,directorypath,startdate,enddate,Startdate,Enddate,Cable_ID,rawfiledic,directory,names36,names30,type36,type30,df,allfile)
import gc
gc.collect()
