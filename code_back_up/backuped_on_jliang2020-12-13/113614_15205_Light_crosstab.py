...
projectname = 'MGM_Light'
minage = 18
maxage = 54
gender = ['F','M']
svodfilter = ['Y','N']
cluster_core = [2,3,4,5,9,10,12,13,15]
cluster_balance = [1]
folderpath = '/home/nielsen/MicroSegment/Code/Crosstab/MGM/Light/'
pathdemo = '/home/nielsen/MicroSegment/Outputs/Demo/Demographicpersonlevel_160101_180114.csv'
pathcluster = '/home/nielsen/MicroSegment/Code/Crosstab/MGM/Light_clusters_15.csv'
