...
"""
import logging
logging.basicConfig(filename='log_BTM_TV1_otlogs.log', level=logging.INFO)
logging.info('otlog6')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/TVONE/BTM/TV1/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/TVONE/BTM/TV1_BTM_Cluster.csv'
...
itlist=['0302814','0405121','0354816','0410866','0406336','0365623','0340230']
balance_cluster=[2]
occasional_cluster=[3,7]
