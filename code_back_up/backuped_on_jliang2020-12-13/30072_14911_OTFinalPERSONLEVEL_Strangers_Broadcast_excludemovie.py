...
"""
import logging
logging.basicConfig(filename='log_strangers_Broadcast_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Strangers/Broadcast/'
...
itlist=[' 822240',' 842158',' 169920',' 836341',' 861951']
balance_cluster=[3]
