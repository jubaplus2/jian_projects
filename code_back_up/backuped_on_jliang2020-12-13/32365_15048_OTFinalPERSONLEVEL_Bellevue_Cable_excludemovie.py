...
"""
import logging
logging.basicConfig(filename='log_bellevue_cable_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WGNA/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WGNA/Bellevue_cluster.csv'
...
itlist=['0390072','0389975','0314758','0358375','0331106','0412109']
balance_cluster=[2]
occasional_cluster=[]
