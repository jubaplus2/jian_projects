...
###outputpath
outputpath='/Users/jubaplus1/Desktop/CMT - Nashville/CMT 6month.csv'
outputpathpersonlevel='/Users/jubaplus1/Desktop/CMT - Nashville/CMT 6monthperson.csv'
...
PersonIntab=pd.read_csv(personintab,dtype={'Week':'object','Weeknumber':'int'})
...
PersonIntab=PersonIntab[PersonIntab['PersonIntab']>0]
...
STARZviewers1=STARZviewers[['HHID']]
STARZviewers1=STARZviewers1.drop_duplicates()
STARZviewers1['HHID']=STARZviewers1['HHID'].astype(int)

STARZviewers1=pd.merge(STARZviewers1,HHIntab2,on='HHID')

STARZviewers1.to_csv(outputpath,index=False)

del STARZviewers1

STARZviewers1=STARZviewers[['HHID','PersonID']]
STARZviewers1=STARZviewers1.drop_duplicates()
STARZviewers1['HHID']=STARZviewers1['HHID'].astype(int)
STARZviewers1['PersonID']=STARZviewers1['PersonID'].astype(int)

STARZviewers1=pd.merge(STARZviewers1,PersonIntab,on=['HHID','PersonID'])

STARZviewers1.to_csv(outputpathpersonlevel,index=False)
