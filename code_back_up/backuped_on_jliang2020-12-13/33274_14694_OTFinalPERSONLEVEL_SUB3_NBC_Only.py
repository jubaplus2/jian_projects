...
"""
import logging
logging.basicConfig(filename='log_SUB3_NBC_Only.log', level=logging.INFO)
logging.info('otlog4')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WGNA/LMS/DOW_HOD/sub3_nbc_only_l3m/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WGNA/LMS/DOW_HOD/Subset3.csv'
...
allfile=allfile[allfile['CableName']==excludecableid]
