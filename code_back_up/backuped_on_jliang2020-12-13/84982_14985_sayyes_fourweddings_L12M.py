...
"""
import logging
logging.basicConfig(filename='sayyes_fourweddings_l12m.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0314637','0330805']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/sayyes_fourweddings_l12m.csv'
