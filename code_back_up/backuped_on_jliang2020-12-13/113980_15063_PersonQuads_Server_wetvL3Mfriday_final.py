...
"""
import logging
logging.basicConfig(filename='wetvl3mfriday.log', level=logging.INFO)
...
finalfiledic='/disk2/Projects/mamajuneoutput/wetvl3mfriday.csv'
...
#jay
allfile.to_csv('/disk2/Projects/mamajuneoutput/check.csv', index = False)
