...
"""
import logging
logging.basicConfig(filename='log_totl_sundance_otlogs.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Sundance/TOTL/Sundance'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/Sundance/TOTL/TOTL_cluster.csv'
...
itlist=['0364702','0420313','0407461','0362201','0406382','0385635','0363743','0374488']
balance_cluster=[2,9]
occasional_cluster=[1,6]
