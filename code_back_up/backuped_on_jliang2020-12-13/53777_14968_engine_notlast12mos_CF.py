...
outputpath = '/home/nielsen/MicroSegment/Engine/Client/GSN/CF/'
###please find buddha
network = 'GSN  '
startdate = 20170409
enddate = 20180401
...
maxage = 54
gender = ['F']
show_dic={'ProgramID':['0368290','0431943','0288040','0402045',' 853310','0241167'],    
         'startdate':['2017-04-09','2017-04-09','2017-04-09','2017-04-09','2017-04-09','2017-04-09'],
         'enddate':['2018-04-01','2018-04-01','2018-04-01','2018-04-01','2018-04-01','2018-04-01']}
...
for j in list(range(nrows)):
    ...
    '''
       ...
       =====`-.____`.___ \_____/___.-`___.-'=====
                         `=---='
    '''
    dfall=pd.read_sql(("select * from telecastlevel where ViewDate>='2017-04-09' AND ViewDate<='2018-04-01' AND HHID_PersonID in %s"%hhidlist),con=engine)
