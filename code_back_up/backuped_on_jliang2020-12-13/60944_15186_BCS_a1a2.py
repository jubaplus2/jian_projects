...
"""
import logging
logging.basicConfig(filename='bcs_a1a2.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0382631','0404728']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/bcs_a1a2.csv'
