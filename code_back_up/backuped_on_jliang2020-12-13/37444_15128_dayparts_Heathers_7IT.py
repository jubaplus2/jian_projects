...
import logging
logging.basicConfig(filename='log_dayparts_heathers.log', level=logging.INFO)
...
projectname='heathers'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/Heathers/'

###### make sure the directory file is up to date
personintabpath='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_170903.csv'
...
itlist=['0420313','0334600',' 861951','0420922','0389683',' 169920','0397803']
...
#names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&((directory['Table'].isin(['C36','B36','S36'])))]
#names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&((directory['Table'].isin(['C30','B30','S30'])))]
...
filedircname=projectname+'daypartsnew_7IT.csv'
allfile.to_csv(filedircname,index=False,sep='\t')
