...
"""
import logging
logging.basicConfig(filename='CW4shows_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=[' 842158',' 842158',' 169920',' 836341']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/CW4shows.csv'
...
names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B36']))]
names36=names36['FilePath']

names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B30']))]
