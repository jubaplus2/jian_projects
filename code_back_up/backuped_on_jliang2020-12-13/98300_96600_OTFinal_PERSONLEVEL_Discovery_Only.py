...
"""
import logging
logging.basicConfig(filename='otlogs_Discovery.log', level=logging.INFO)
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/disk2/Projects/Swamp_People_OT/Discovery/'
...
itlist=['0349473','0350060','0406139']
balance_cluster=[5]
