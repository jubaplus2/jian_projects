...
"""
import logging
logging.basicConfig(filename='log_eli_cable_Show.log', level=logging.INFO)
logging.info('otlog3')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Crimemovie/Eliz/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Crimemovie/Eliz/elizabeth_cluster.csv'
...
itlist=['0383772','0395373','0393342','0252195','0393342','0261238','0392780']
balance_cluster=[4]
