...
"""
import logging
logging.basicConfig(filename='walkingdead_AHS_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0338150','0347743']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/walkingdead_AHS_L12M.csv'
