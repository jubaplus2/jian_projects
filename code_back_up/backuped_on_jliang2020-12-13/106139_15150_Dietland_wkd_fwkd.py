...
"""
import logging
logging.basicConfig(filename='walkingdead_fearwalkingdead.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0338150','0389703']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/walkingdead_fearwalkingdead.csv'
