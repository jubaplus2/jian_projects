...
def create_Pred_act_table_GU_id():
    with engine_pymysql_db_BL.cursor() as cur:
        ...
        cur.execute("CREATE TABLE Pred_Activity_GU_id(Event_Time bigint, date_utc date, time_utc time, User_ID varchar(64), Customer_Link varchar(128), customer_id_hashed varchar(64), Activity_ID varchar(16), url varchar(2048), search_term varchar(256), session_sequence int, activity_sequence int);")
