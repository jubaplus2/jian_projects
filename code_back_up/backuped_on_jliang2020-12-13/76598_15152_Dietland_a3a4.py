...
"""
import logging
logging.basicConfig(filename='dietland_a3a4.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=[' 845565',' 839643']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/dietland_a3a4.csv'
