...
foldername='/Users/jubaplus1/Desktop/Freeform/Shadowhunters S2/All IT/OT/Cable'
...
###put IT Shows here
itlist=['0397753','0396388','0397672','0380787','0397803','0385468']
balance_cluster=[6]
...
i='/Users/Jubaplus1/Desktop/Nielsen/NPM_ARD_W_2016_05_08_BPGM_R0/N16051D0.EPG'
df=pd.DataFrame()
type30=pd.DataFrame()
for i in names30:
    df=pd.read_csv(i,sep='\t')
...
#np.where((type30.ProgramName.str.contains('tonight',case=False))&(type30.ProgramName.str.contains('mintue',case=False)),1,
#np.where((type30.ProgramName.str.contains('the',case=False))&(type30.ProgramName.str.contains('view',case=False)),1,
#np.where((type30.ProgramName.str.contains('j',case=False))&(type30.ProgramName.str.contains('kimmel',case=False)),1,0)))))
