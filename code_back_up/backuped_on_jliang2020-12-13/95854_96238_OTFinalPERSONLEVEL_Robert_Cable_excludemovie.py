...
"""
import logging
logging.basicConfig(filename='log_robert_cable_Show.log', level=logging.INFO)
logging.info('otlog3')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Crimemovie/Robert/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Crimemovie/Robert/robert_cluster.csv'
...
itlist=['0291826','0389185','0383595','0235194','0382630','0387673','0326983']
balance_cluster=[10]
occasional_cluster=[4,7]
