...
quadspath=''
viewershippath=''
itshowpath='/Users/jubaplus1/Desktop/Z living/YogaGirls/yogagirls_showaffinity_cluster_code.csv'
otshowpath='/Users/jubaplus1/Desktop/Z living/YogaGirls/OT/programfreq.csv'
bcastotindicator='F'
otshowpath1 = ['']
ga1='/Users/jubaplus1/Desktop/Z living/Sizing/zliving_yoga_l12m_a1.csv'
ga2='/Users/jubaplus1/Desktop/Z living/Sizing/zliving_yoga_l12m_a2.csv'
...
###otshownames:
#otshowpath1
otshownames1=['TNT  _SUPERNATURAL             ','TV1  _GOOD TIMES               ','ENT  _CHRISLEY KNOWS BEST      ','MTV2 _WAYANS BROS.             ','FRFM _MIDDLE, THE              ','VH1  _HIP HOP SQUARES          ','TLC  _FOUR WEDDINGS            ','OWN  _IYANLA, FIX MY LIFE      ','MTV  _FEAR FACTOR MTV          ','WETV _BRAXTON FAMILY VALUES    ','BRVO _SWEET HOME OKLAHOMA      ','ENT  _ARRANGEMENT              ']
#otshowpath2
otshownames2=['']
#otshowpath3
otshownames3=['']
...
df.to_csv("AudienceSizing_yogagirls.csv",index=False)
print(datetime.datetime.now())
