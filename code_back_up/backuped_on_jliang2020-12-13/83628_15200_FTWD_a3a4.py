...
"""
import logging
logging.basicConfig(filename='ftwd_a3a4.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0376675','0427148',' 839297']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/ftwd_a3a4.csv'
