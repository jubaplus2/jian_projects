...
"""
import logging
logging.basicConfig(filename='LWATL_LWLA_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0398595','0375581']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/LWATL_LWLA_L12M.csv'
