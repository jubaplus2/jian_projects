...
df['finalsegment']=np.where((df['A1mins']>30)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['Age'].isin(range(40,55)))&(df['Race']==2),'A1',
                            ...
                            np.where((df['ot3']>150)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['Age'].isin(range(40,55)))&(df['Race']==2),'A3',
                            np.where((df['ot4']>150)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['Age'].isin(range(40,55)))&(df['Race']==2),'A4',
