...
"""
import logging
logging.basicConfig(filename='otlogs_cable.log', level=logging.INFO)
logging.info('otlogswamp')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/disk2/Projects/Swamp_People_OT/Cable/'

###### make sure the directory file is up to date
clusterpath='/disk2/Projects/Swamp_People_OT/swamp_cluster.csv'
...
itlist=['0336088','0354756','0399135','0352763','0339215','0349473','0350060','0406139']
balance_cluster=[5]
occasional_cluster=[8,10]
...
excludecableid=['008908','006218','006530','008338','006196','008336']
...
for i in excludecableid:
    allfile=allfile[allfile['CableID']!=i]
