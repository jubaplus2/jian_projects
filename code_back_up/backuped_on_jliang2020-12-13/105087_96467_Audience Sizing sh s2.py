...
demofilepath='/Users/jubaplus1/Desktop/Nielsen/demographichhid0221-0821.csv'
itshowpath='/Users/jubaplus1/Desktop/Freeform/Shadowhunters S2/All IT/shadow showaffnity all IT.csv'
otshowpath='/Users/jubaplus1/Desktop/Freeform/Shadowhunters S2/All IT/OT/Cable/programfreq.csv'
####put startdate and enddate for the project here:
Startdate=20160521
Enddate=20160821


##### For Quads update Cable ID (WeTV: '007516',SUND: '007602',STARZ: '009157', WGNA: '006788',CMT: '006647',MTV: '006198')
Cable_ID='006201'
...
itseg_a2=['Totalfreq833433','Totalfreq198685','Totalfreq397753','Totalfreq397672']
itseg_a3=[]
itseg_a4=[]

###otshownames:
otshownames=['HALL _GOLDEN GIRLS             ','HBOM _BREAK                    ','DSNY _GIRL MEETS WORLD         ','TBSC _FRIENDS                  ','TNT  _SUPERNATURAL             ','TNT  _CASTLE                   ','MTV  _RIDICULOUSNESS           ','MTV  _RIDICULOUSNESS BEST OF   ','MTV  _RIDICULOUSNESS SPECIAL   ','MTV  _RIDICULOUSNESS SSN2      ','MTV  _RIDICULOUSNESS SSN2B     ','MTV  _RIDICULOUSNESS SSN3      ','MTV  _RIDICULOUSNESS SSN3B     ','MTV  _RIDICULOUSNESS SSN4      ','MTV  _RIDICULOUSNESS SSN5      ','MTV  _RIDICULOUSNESS SSN6      ','MTV  _RIDICULOUSNESS SSN7      ','MTV  _RIDICULOUSNESS SSN7B     ','MTV  _RIDICULOUSNESS SSN8      ','AMC  _WALKING DEAD             ','AMC  _WALKING DEAD MARATHON    ','AMC  _WALKING DEAD S7 PREVIEW  ','TNT  _CHARMED                  ','FX   _HOW I MET YOUR MOTHER    ','LIF  _GREYS ANATOMY            ','SPIKE_LIP SYNC BATTLE          ','SPIKE_LIP SYNC BATTLE: TMI     ','USA  _CHRISLEY KNOWS BEST      ','TVL  _REBA                     ','BBCA _STAR TREK: NXT GENERATION','TNNK _RUGRATS                  ','AMC  _FEAR THE WALKING DEAD    ','AMC  _FEAR THE WALKING DEAD MAR','CMDY _ARCHER                   ','TRAV _GHOST ADV AFTERSHOCKS    ','TRAV _GHOST ADVENTURES         ','TRAV _GHOST ADVENTURES REV     ','SCI  _MYTHBUSTERS              ','TRAV _BIZARRE FOODS W/ANDREW Z ','CMDY _AT MIDNIGHT              ','MTV  _MTV2 WILD N ON TOUR      ','MTV  _MTV2 WILD N OUT          ','MTV  _MTV2 WILD N OUT S6 SPECIA','ADSM _DRAGON BALL Z KAI        ','DFC  _MY LITTLE PONY FRIENDSHIP','MTV  _CATFISH SPECIAL          ','MTV  _CATFISH SSN3 AFTER SHOW  ','MTV  _CATFISH: THE TV SHOW     ','MTV  _CATFISH: THE TV SHOW SSN2','MTV  _CATFISH: THE TV SHOW SSN3','MTV  _CATFISH: THE TV SHOW SSN4','MTV  _CATFISH: THE TV SHOW SSN5','MTV  _CATFISH:THE TV SHOW SSN4B','MTV  _CATFISH:THE TV SHOW SSN5B','BRVO _BELOW DECK               ','BRVO _BELOW DECK MEDITERRANEAN ','BRVO _BELOW DECK MEDITRANEAN FL','FX   _ACS: PEOPLE V. OJ SIMPSON','MTV  _TRUE LIFE                ','MTV  _TRUE LIFE PRESENTS       ','DXD  _LAB RATS                 ','DXD  _LAB RATS - LN            ','DXD  _LAB RATS VS. MIGHTY MED  ','DXD  _LAB RATS: ELITE FORCE    ','DXD  _LAB RATS: ELITE FORCE-LN ']
...
ITshows['HHID']=ITshows['HHID_PersonID'].str[0:7].astype('int')
ITshows=ITshows[['HHID', 'segment','ShiftedViewindicatorallprogram']]
ITshows.columns=['HHID','Segment','ShiftedViewindicatorallprogram']
ITshows=ITshows.drop_duplicates('HHID')
...
OTshows['HHID']=OTshows['HHID_PersonID'].str[0:7].astype('int')

OTshows=OTshows[['HHID','OT']]
OTshows=OTshows.drop_duplicates('HHID')

df=pd.merge(OTshows,df,on='HHID',how='outer')

df.to_csv("AudienceSizingV2.csv",index=False)
