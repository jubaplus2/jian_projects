...
"""
import logging
logging.basicConfig(filename='log_housepoor_cable_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Zliving/housepoor/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/Zliving/housepoor_cluster.csv'
