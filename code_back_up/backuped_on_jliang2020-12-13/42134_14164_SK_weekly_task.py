...
def Smoothie_King_weekly():
    ...
    Starting_Monday=datetime.date(2019,8,5)
...
Jian
        ...
        store_GPS_verified=pd.read_excel("/home/jian/Projects/Smoothie_King/TA/QC_address/SK_store_listed_verified_JL_2019-08-06.xlsx",sheetname="assigned_lat_long",dtype=str)
