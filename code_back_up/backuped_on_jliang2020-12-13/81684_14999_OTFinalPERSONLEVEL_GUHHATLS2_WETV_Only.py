...
"""
import logging
logging.basicConfig(filename='log_guhhatls2_WETV_otlogs.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/GUHHATLS2/WETV/'
...
itlist=['0424948','0343256','0397489']
balance_cluster=[2]
