...
"""
import logging
logging.basicConfig(filename='log_GUHH4_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/GUHH4/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WEtv/GUHH4/GUHH4_cluster.csv'
