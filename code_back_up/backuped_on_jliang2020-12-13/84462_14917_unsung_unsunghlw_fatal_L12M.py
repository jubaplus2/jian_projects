...
"""
import logging
logging.basicConfig(filename='unsung_unsunghlw_fatal_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0322185','0373161','0365794']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/unsung_unsunghlw_fatal_L12M.csv'
