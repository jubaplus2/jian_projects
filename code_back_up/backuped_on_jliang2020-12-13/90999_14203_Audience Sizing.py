...
HHIntab=pd.read_csv("/Users/Jubaplus/Desktop/type25all.csv",dtype={'Week':'object','Weeknumber':'int'})
...
HHIntab2=HHIntab[(HHIntab['ViewDate']>='2016-03-14')&(HHIntab['ViewDate']<='2016-06-12')]
...
df=pd.read_csv("/Users/Jubaplus/Desktop/demographichhid.csv")
...
names36=['/Users/Jubaplus/Desktop/Nielsen/NPM_ARD_W_2016_05_08_CBLNM_R0/N16051V0.ECN',
...
names30=['/Users/Jubaplus/Desktop/Nielsen/NPM_ARD_W_2016_02_21_CBLNM_R0/N16022D0.ECN',
...
ITshows=pd.read_csv('/Users/Jubaplus/Desktop/showaffinitysundwtcluster.csv')
ITshows['segment']=np.where(((ITshows['Totalfreq398427']>0)|()),"A1",
np.where(((ITshows['Totalfreq374888']>0)|(ITshows['Totalfreq348347']>0)|(ITshows['Totalfreq319940']>0)),'A2',
         np.where(ITshows['Totalfreq399801']>0,"A3",'Other')))        
...
OTshows1=pd.read_csv('/Users/Jubaplus/Desktop/otshowsp1.csv')
OTshows2=pd.read_csv('/Users/Jubaplus/Desktop/otshowsp2.csv')
OTshows=pd.merge(OTshows1,OTshows2,on=['HHID'])
#####update the show names
OTshows['OT']=np.where(((OTshows['ADSM._AMERICAN.DAD']>0)|(OTshows['ADSM._AKAME.GA.KILL']>0)|(OTshows['WGNA._HOW.I.MET.YOUR.MOTHER']>0)),1,0)
...
df.to_csv("/Users/Jubaplus/Desktop/demographicsoutlanders2.csv")
