...
import logging
logging.basicConfig(filename='log_dayparts_wetv_bfvs6.log', level=logging.INFO)
...
projectname='wetv_bfvs6'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/Wetv/BFV6A/'
