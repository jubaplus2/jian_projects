...
"""
import logging
logging.basicConfig(filename='otlogs_sundance.log', level=logging.INFO)
logging.info('otlogshl2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/disk2/OTProject/Sundance_HLS2_OT/Sundance/'

###### make sure the directory file is up to date
clusterpath='/root/AudienceSizing/OT/Sundance_HLS2_OT/HL2Cluster.csv'
...
###change Cable ID### when run include excludeid=F,when run exclue, exclude id=T
exclueid='F'
excludecableid='007602'
