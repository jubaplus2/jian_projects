...
"""
import logging
logging.basicConfig(filename='zliving_droz_l12m_a3.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=[' 188780','0340224']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/zliving_droz_l12m_a3.csv'
...
names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['S36','C36']))]
names36=names36['FilePath']

names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['S30','C30']))]
