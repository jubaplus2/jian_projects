...
"""
import logging
logging.basicConfig(filename='personintablogs_160101_170416.log', level=logging.INFO)
...
Enddate=20170416
###THIS IS output
lastupdatepath = '/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_170402.csv'
finaldirct='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_170416.csv'
...
lastfile =  pd.read_csv(lastupdatepath,dtype = 'str')
lastfile['PersonIntab']=lastfile['PersonIntab'].astype(int)
lastfile['HHIntab']=lastfile['HHIntab'].astype(int)
lastfile['ViewDate']=pd.to_datetime(lastfile['ViewDate'])

PersonIntab = PersonIntab.append(lastfile, ignore_index = True)
PersonIntab=PersonIntab.drop_duplicates(['HHID', 'PersonID','ViewDate'])

PersonIntab.to_csv(finaldirct,index=False)
