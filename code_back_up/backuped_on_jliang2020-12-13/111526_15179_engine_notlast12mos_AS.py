...
outputpath = '/home/nielsen/MicroSegment/Engine/Client/AMC/L49/'
###please find buddha
network = 'AMC  '
startdate = 20150401
enddate = 20160401
...
for j in list(range(nrows)):
    ...
    '''
       ...
       =====`-.____`.___ \_____/___.-`___.-'=====
                         `=---='
    '''
    dfall=pd.read_sql(("select * from telecastlevel where ViewDate>='2015-04-01' AND ViewDate<='2016-04-01' AND HHID_PersonID in %s"%hhidlist),con=engine)
