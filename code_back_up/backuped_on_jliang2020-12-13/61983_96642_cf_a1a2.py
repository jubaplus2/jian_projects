...
"""
import logging
logging.basicConfig(filename='cf_a1a2.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0241167','0241159','0241179']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/cf_a1a2.csv'
