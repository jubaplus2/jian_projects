...
"""
import logging
logging.basicConfig(filename='unsung_fatal_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0322185','0365794']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/unsung_fatal_L12M.csv'
