...
import logging
logging.basicConfig(filename='log_dayparts_GSN_CAROellen.log', level=logging.INFO)
...
projectname='GSN_CAROellen'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/GSN/CARO/'

###### make sure the directory file is up to date
personintabpath='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_180408.csv'
...
itlist=['0288040','0402045',' 853310','0241167','0241159','0241179','0140083']
...
names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&((directory['Table']=='C36')|(directory['Table']=='B36')|(directory['Table']=='S36'))]
names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&((directory['Table']=='C30')|(directory['Table']=='B30')|(directory['Table']=='S30'))]
...
for i in names36:
    ...
    df = df[df['TimeShiftedViewingCode']!='3']
