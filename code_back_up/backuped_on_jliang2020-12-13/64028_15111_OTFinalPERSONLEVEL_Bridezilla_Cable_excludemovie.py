...
"""
import logging
logging.basicConfig(filename='log_bride_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/BRIDE/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WEtv/BRIDE/Bridezillas_code.csv'
