...
"""
import logging
logging.basicConfig(filename='log_heathers_cable_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Heathers/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/Heathers/heathers_cluster.csv'
...
itlist=['0420313','0334600','0420922','0389683','0397803']
balance_cluster=[6]
occasional_cluster=[]
