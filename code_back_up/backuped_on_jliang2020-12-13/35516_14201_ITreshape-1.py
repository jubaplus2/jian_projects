...
test.to_csv('/Users/jubaplus/Desktop/Epnames.csv',index=False)
'''
test=pd.read_csv('/Users/jubaplus/Desktop/Epnames.csv')
...
hhintab.to_csv("/Users/jubaplus1/Desktop/WETV MBC S6/showaffinitysund.csv",index=False)
