...
"""
import logging
logging.basicConfig(filename='zliving_droz_l12m_a1.log', level=logging.INFO)
...
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/zliving_droz_l12m_a1.csv'
...
names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B36','S36']))]
names36=names36['FilePath']

names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B30','S30']))]
