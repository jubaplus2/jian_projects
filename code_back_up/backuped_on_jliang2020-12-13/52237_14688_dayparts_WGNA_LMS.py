...
import logging
logging.basicConfig(filename='log_dayparts_cmt_lms.log', level=logging.INFO)
...
projectname='CMT_LMS'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/WGNA/LMS/'

###### make sure the directory file is up to date
personintabpath='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_180318.csv'
