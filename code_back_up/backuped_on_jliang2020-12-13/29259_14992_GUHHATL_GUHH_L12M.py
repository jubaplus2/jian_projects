...
"""
import logging
logging.basicConfig(filename='GUHHATL_GUHH_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0397489','0424948']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/GUHHATL_GUHH_L12M.csv'
