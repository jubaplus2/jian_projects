...
"""
import logging
logging.basicConfig(filename='log_yogagirls_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Zliving/yogagirls/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/Zliving/yogagirls_cluster.csv'
