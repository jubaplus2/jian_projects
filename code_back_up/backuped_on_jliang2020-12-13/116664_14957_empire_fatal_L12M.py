...
"""
import logging
logging.basicConfig(filename='empire_fatal_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0404749','0365794']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/empire_fatal_L12M.csv'
