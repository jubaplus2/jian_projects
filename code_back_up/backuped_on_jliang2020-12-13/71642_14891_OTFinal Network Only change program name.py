...
foldername='/Users/jubaplus1/Desktop/MTV - Sweet+Vicious/MTV ONLY OT'

###### make sure the directory file is up to date
directorypath='/Users/jubaplus1/Desktop/Code/New Code/NielsenDirectory.csv'
daypartspath='/Users/jubaplus1/Desktop/MTV - Sweet+Vicious/IT-HH-ViewershipDayPartsNew.csv'
clusterpath='/Users/jubaplus1/Desktop/MTV - Sweet+Vicious/MTV CLUSTER.csv'
...
df=pd.read_csv(daypartspath,sep='\t',dtype={'Household Number':'object'})
...
allfile=pd.read_csv('/Users/jubaplus1/Desktop/MTV - Sweet+Vicious/MTV ONLY OT/alltransaction.csv')
...
allfile['freq']=1
allfile['programnew']=allfile['CableName']+'_'+allfile['ProgramName_New']
...
hourfreq=pd.merge(hourfreq,Cluster,on=['HHID'])
hourfreq=hourfreq[hourfreq['Clusters']=='Core']
hourfreq.to_csv('/Users/jubaplus1/Desktop/hourfreq.csv',index=False)
...
hourmin=pd.merge(hourmin,Cluster,on=['HHID'])
hourmin=hourmin[hourmin['Clusters']=='Core']
hourmin.to_csv('/Users/jubaplus1/Desktop/hourmin.csv',index=False)
...
dayfreq=pd.merge(dayfreq,Cluster,on=['HHID'])
dayfreq=dayfreq[dayfreq['Clusters']=='Core']
dayfreq.to_csv('/Users/jubaplus1/Desktop/dayfreq.csv',index=False)
...
daymin=pd.merge(daymin,Cluster,on=['HHID'])
daymin=daymin[daymin['Clusters']=='Core']
daymin.to_csv('/Users/jubaplus1/Desktop/daymin.csv',index=False)
...
networkfreq=pd.merge(networkfreq,Cluster,on=['HHID'])
networkfreq=networkfreq[networkfreq['Clusters']!='Occasional']
networkfreq.to_csv('/Users/jubaplus1/Desktop/networkfreq.csv',index=False)
...
networkmin=pd.merge(networkmin,Cluster,on=['HHID'])
networkmin=networkmin[networkmin['Clusters']!='Occasional']
networkmin.to_csv('/Users/jubaplus1/Desktop/networkmin.csv',index=False)
...
programfreq=pd.merge(programfreq,Cluster,on=['HHID'])
programfreq=programfreq[programfreq['Clusters']!='Occasional']
programfreq.to_csv('/Users/jubaplus1/Desktop/programfreq.csv',index=False)
...
programmin=pd.merge(programmin,Cluster,on=['HHID'])
programmin=programmin[programmin['Clusters']!='Occasional']
programmin.to_csv('/Users/jubaplus1/Desktop/programmin.csv',index=False)
...
totalfre2.to_csv('/Users/jubaplus1/Desktop/shiftedviewing.csv',index=False)
...
shiftnetwork.to_csv('/Users/jubaplus1/Desktop/shiftedviewingnetwork.csv')
...
shiftnetwork.to_csv('/Users/jubaplus1/Desktop/shiftedviewingprogram.csv')
