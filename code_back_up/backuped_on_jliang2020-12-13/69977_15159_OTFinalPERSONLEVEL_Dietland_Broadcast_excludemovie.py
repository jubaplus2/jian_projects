...
"""
import logging
logging.basicConfig(filename='log_Dietland_Broadcast_Show.log', level=logging.INFO)
logging.info('otlog2')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AMC/Dietland/Broadcast/'
