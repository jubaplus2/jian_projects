...
"""
import logging
logging.basicConfig(filename='log_SUB1_WGNA_Only.log', level=logging.INFO)
logging.info('otlog1')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WGNA/Chicago_Fire/DOW_HOD/sub1_wgna_only_l3m/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WGNA/Chicago_Fire/DOW_HOD/Subset1.csv'
