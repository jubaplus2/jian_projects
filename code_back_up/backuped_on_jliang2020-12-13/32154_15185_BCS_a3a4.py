...
"""
import logging
logging.basicConfig(filename='bcs_a3a4.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0427148',' 856852','0374410']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/bcs_a3a4.csv'
...
names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['C36','B36']))]
