...
"""
import logging
logging.basicConfig(filename='log_BCS_cable_Show.log', level=logging.INFO)
logging.info('otlog3')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AMC/BCS/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AMC/BCS/BCS_cluster2.csv'
...
itlist=['0374163','0408433','0427148','0374410']
balance_cluster=[4,5]
