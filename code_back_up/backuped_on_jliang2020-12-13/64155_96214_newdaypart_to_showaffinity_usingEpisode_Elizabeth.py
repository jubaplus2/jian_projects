...
inputpath='/Users/jubaplus1/Downloads/AEN_Elizabethdaypartsnew.csv'
...
itlist=[383772,395373,231,5268,393342,252195,261238,392780,393343]
startds=[20160101,20151127,20160801,20160801,20160214,20160101,20160910,20170611,20160101]
endds=[20170803,20160122,20170801,20170801,20170424,20161230,20160911,20170611,20171230]
...
df['EpisodeName'] = np.where(df['ProgramCode'].isin([231,5268]),'ep',df['EpisodeName'])
...
hhintab.to_csv("/Users/jubaplus1/Downloads/elizabeth_showaffinitynew1.csv",index=False)
