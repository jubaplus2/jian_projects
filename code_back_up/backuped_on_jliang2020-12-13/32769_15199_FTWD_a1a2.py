...
"""
import logging
logging.basicConfig(filename='ftwd_a1a2.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0394845','0389703','0404728']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/ftwd_a1a2.csv'
