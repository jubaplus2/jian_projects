...
"""
import logging
logging.basicConfig(filename='cable_ot.log', level=logging.INFO)
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/disk2/OTProject/Lifetime/BlackMagic/Cable/'

###### make sure the directory file is up to date
clusterpath='/root/AudienceSizing/OT/Lifetime_Vivica/blackmagiccluster.csv'
...
itlist=['0320916','0375581','0398595','0365623','0396537','0398534','0398535','0397489','0343256']
balance_cluster=[6]
occasional_cluster=[8]
...
###change Cable ID###
excludecableid=['006196','006218','008338']
