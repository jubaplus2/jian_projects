...
"""
import logging
logging.basicConfig(filename='log_Dietland_cable_Show.log', level=logging.INFO)
logging.info('otlog3')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AMC/Dietland/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AMC/Dietland/Dietland_cluster.csv'
...
itlist=['0385635','0420931','0380668','0410938','0434545']
balance_cluster=[1,2,7]
occasional_cluster=[9]
...
###change Cable ID###
excludecableid=['006593','008250','006111','007602','007516']
