...
import logging
logging.basicConfig(filename='log_dayparts_DanceMom_Broadcast.log', level=logging.INFO)
...
projectname='Lifetime_DanceMom_Broadcast'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/AEN/Dance Mom/Broadcast'
