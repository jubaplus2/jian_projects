...
"""
import logging
logging.basicConfig(filename='gsn_a1a2.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0352983','0241167','0241160']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/gsn_a1a2.csv'
