...
"""
import logging
logging.basicConfig(filename='log_Marymary2_WEtv_otlogs.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/Marymary2/WETV'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WEtv/Marymary2/MaryMary2Cluster.csv'
...
itlist=['0408558','0402099','0320916','0363715','0406336','0353099','0343256']
balance_cluster=[4]
