...
#path = '/disk2/Projects/Rentrak/20151116-20151129/'
#path = '/disk2/Projects/Rentrak/20151130-20151213/'
#path = '/disk2/Projects/Rentrak/20151214-20151227/'
#path = '/disk2/Projects/Rentrak/20151228-20160110/'
#path = '/disk2/Projects/Rentrak/20160111-20160124/'
...
def ncreatoutput1():
	...
	#lheader, weeklength, prevweekdf, weekinfodict = previousweekFile('optoutput12.csv')
	lheader, weeklength, prevweekdf, weekinfodict = previousweekFile('Show2294631W10.csv')
	print lheader
	print 'hit ncreatoutput1'
	print ' first previousweekFile written'
	header = '\t'.join(lheader)+'\n'
	f = open('Show2294631W11.csv','w')
        f.write(header)
        f.close()
	...
	showidToName = {'2294631': ('STARZ', 'How to Get Away With Murder')}
				...
				if tt.get(elements1[0]):
					...
					for elements in usngzip4list:
						...
						if not searchinDF(prevweekdf,weekinfodict, inputlist, elements1[1]):
							...
							df.to_csv('Show2294631W11.csv','\t', index = False, mode='a', header=False)
	print 'dumping data'
	prevweekdf.to_csv('Show2294631W11.csv','\t', index = False, mode='a', header=False)
	print 'arnab6'
