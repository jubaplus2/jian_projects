...
"""
import logging
logging.basicConfig(filename='lif_a1_l6m.log', level=logging.INFO)
...
##### update Cable ID (WeTV: '007516',SUND: '007602',STARZ: '009157', WGNA: '006788', lifetime: '006196')
Cable_ID='006196'
Program_ID=['0373522','0397262','0398595']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/lif_a1_l6m.csv'
...
totalmins = totalmins[totalmins['Totalmins']>=200]
