...
"""
import logging
logging.basicConfig(filename='zliving_housepoor_l12m.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0348886','0401106','0365468']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/zliving_housepoor_l12m.csv'
...
names36=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B36','C36']))]
names36=names36['FilePath']

names30=directory[(directory['Week']<=enddate)&(directory['Week']>=startdate)&(directory['Table'].isin(['B30','C30']))]
