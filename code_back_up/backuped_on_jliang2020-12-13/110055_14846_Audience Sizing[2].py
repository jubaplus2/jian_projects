...
HHIntab2=HHIntab[(HHIntab['ViewDate']>='2016-04-08')&(HHIntab['ViewDate']<='2016-07-11')]
...
df=pd.read_csv("/Users/jubaplus1/Desktop/Nielsen/demographichhid0811.csv")
...
df=demo
df=pd.merge(STARZviewers,df,on='HHID',how='outer')
df['Quads'].fillna(0,inplace=True)

ITshows=pd.read_csv('/Users/jubaplus1/Desktop/Starz - Ash vs Evil Dead/showaffinityashvsevil.csv')
ITshows['segment']=np.where(((ITshows['Totalfreq393896']>0)|(ITshows['Totalfreq398398']>0)),"A1",
np.where(((ITshows['Totalfreq338150']>0)|(ITshows['Totalfreq389703']>0)|(ITshows['Totalfreq347743']>0)),'A2',
         np.where(((ITshows['Totalfreq376675']>0)|(ITshows['Totalfreq396336']>0)),"A3",'Other'))) 
...
OTshows=pd.read_csv('/Users/jubaplus1/Desktop/Starz - Ash vs Evil Dead/B OT/b otshowsnew.csv')
OTshows2=pd.read_csv('/Users/jubaplus1/Desktop/Starz - Ash vs Evil Dead/C OT/c otshowsnew.csv')
OTshows=pd.merge(OTshows,OTshows2,on='HHID',how='outer')

#####update the show names
OTshows['OT']=np.where(((OTshows['CW..._IZOMBIE']>0)|(OTshows['FOX.._X.FILES']>0)|(OTshows['CW..._CONTAINMENT']>0)|(OTshows['CW..._VAMPIRE.DIARIES']>0)|(OTshows['CW..._SUPERNATURAL']>0)|(OTshows['NBC.._GRIMM']>0)|(OTshows['HBOM._UNFRIENDED']>0)|(OTshows['AEN.._DAMIEN']>0)),1,0)
OTshows=OTshows[OTshows['OT']==1]
OTshows=OTshows[['HHID','OT']]
df=pd.merge(OTshows,df,on='HHID',how='outer')

df.to_csv("/Users/jubaplus1/Desktop/Starz - Ash vs Evil Dead/demographicsASHwithOT.csv")
