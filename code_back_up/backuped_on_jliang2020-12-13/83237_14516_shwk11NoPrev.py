...
#path = '/disk2/Projects/Rentrak/20151019-20151101/'
#path = '/disk2/Projects/Rentrak/20151102-20151115/'
#path = '/disk2/Projects/Rentrak/20160125-20160207/'
path = '/home/account1/Projects/Rentrak/20160208-20160221/'
llpath = '/home/account1/Projects/Rentrak/zip4_lat_lon_usng.csv'
updatedfile = '/home/account1/Projects/Rentrak/Mediastorm_USNG_tile_query_updated_with_geography.txt'
...
#Currently ref file is present in /home/account1/Projects/Rentrak/20150907-20150920/
def getShowidToName (refFile):
	lpath = '/home/account1/Projects/Rentrak/20150907-20150920/'
...
def previousweekFile(inputfile):
        v = pd.read_csv(inputfile, '\t',dtype = str)
							#df.to_csv('optoutput3.csv','\t', index = False, mode='a', header=False)
	...
	framelist = [v [(v.iloc[0:,0] == str(elements))] for elements in showlist]
...
def ncreatoutput1():
	...
	#lheader, weeklength, prevweekdf, weekinfodict = previousweekFile('/disk2/arnab/rentrak/week3/2293230/Show2293230W3.csv')
	#header = '\t'.join(lheader)+'\n'
	header = 'ShowID\tNetwork_no\tShowName\tUSNG_100\tZip\tZip4\tRank20150907-20150920\tRank20150921-20151004\tRank20151005-20151018\tRank20151019-20151101\tRank20151102-20151115\tRank20151116-20151129\tRank20151130-20151213\tRank20151214-20151227\tRank20151228-20160110\tRank20160111-20160124\tRank20160125-20160207\tRank20160208-20160221\t\n'
	print header
	#w0,w1,w2,w3,w4...w10 so 11 length
	weeklength = 11 
	f = open('Show1995902W11.csv','w')
        f.write(header)
        f.close()
	showidToFileName, refFile = getShowidToUsngFileNameAndrefFile()
	showidToName = getShowidToName(refFile)
 	showidToName = {'1995902': ('STARZ', 'GIRLS S5')}
			...
			for elements1 in showIDToUsngAndRank:
				if tt.get(elements1[0]):
					...
					for elements in usngzip4list:
						...
						df.to_csv('Show1995902W11.csv','\t', index = False, mode='a', header=False)
	print 'arnab6'
