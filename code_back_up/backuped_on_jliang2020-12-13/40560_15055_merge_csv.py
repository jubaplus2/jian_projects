...
print 'reading files'
quads = pd.read_csv('/disk2/Projects/AudienceSizing/QuadsSundanceL6M.csv')

personintab1 = pd.read_csv('/disk2/Projects/AudienceSizing/type26_16325_16925.csv')
...
# ... ... 
personintab = pd.concat([personintab1, personintab2,], ignore_index = True)
