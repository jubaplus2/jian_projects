...
"""
import logging
logging.basicConfig(filename='log_oscar_cable_Show.log', level=logging.INFO)
logging.info('otlog3')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Crimemovie/Oscar/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Crimemovie/Oscar/Oscar_cluster.csv'
...
itlist=['0400710','0400804','0401333','0283767','0374497','0422612','0393342','0393343']
balance_cluster=[1]
occasional_cluster=[5]
