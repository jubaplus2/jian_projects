...
"""
import logging
logging.basicConfig(filename='log_light_cable_Show.log', level=logging.INFO)
logging.info('otloglight')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/MGM/Light/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/MGM/Light_cluster.csv'
