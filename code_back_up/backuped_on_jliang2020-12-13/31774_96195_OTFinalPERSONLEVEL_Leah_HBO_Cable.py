...
"""
import logging
logging.basicConfig(filename='log_Leah_HBO_cable_otlogs.log', level=logging.INFO)
logging.info('otlog_leah_hbo')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Leah_HBO'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Leah_HBO/HBO_showaffnity_CLUSTER.csv'
...
itlist=['0383849']
balance_cluster=[1,2,4,10]
occasional_cluster=[3,5]
