...
foldername='/Users/jubaplus1/Desktop/Vivica/Sizing'

###### make sure the directory file is up to date
personintab='/Users/jubaplus1/Desktop/Vivica/Sizing/personintab151108_161023.csv'
demofilepath='/Users/jubaplus1/Desktop/Vivica/Sizing/Demographicpersonlevel.csv'
quadspath='/Users/jubaplus1/Desktop/Vivica/Sizing/QuadsLifetimeL3M.csv'
viewershippath='/Users/jubaplus1/Desktop/Vivica/Sizing/ViewershipClassification.csv'
itshowpath='/Users/jubaplus1/Desktop/Vivica/balckmagic_showaffinitywithcluster.csv'
otshowpath='/Users/jubaplus1/Desktop/Vivica/OT/Cable OT/programfreq.csv'
...
numberofitshows=4
itseg_a1=['Totalfreq375581','Totalfreq398595']
itseg_a2=['Totalfreq382631','Totalfreq285477','Totalfreq363137']
itseg_a3=['Totalfreq320916','Totalfreq396537','Totalfreq398534','Totalfreq398535','Totalfreq365623','Totalfreq397489']
itseg_a4=['Totalfreq320916','Totalfreq398595','Totalfreq365623','Totalfreq398534','Totalfreq397489']
...
ITshows['seg_a2']=np.where(((ITshows['Totalfreq320916']>0)&(ITshows['Totalfreq396537']>0)&(ITshows['Totalfreq398534']>0)&(ITshows['Totalfreq398535']>0)),1,0)
...
if numberofitshows==4:
    ...
    ITshows['segment']=np.where(ITshows['seg_a1']>0,"A1",np.where(ITshows['seg_a2']>0,'A2',np.where((ITshows['seg_a3']>0)&(ITshows['ShiftedViewindicatorallprogram']==1),'A3',np.where(ITshows['seg_a4']>0,'A4','Other'))))
...
df.to_csv("AudienceSizingblackmagic1123for_overlap.csv",index=False)
