...
weather_forecast_file_13="/home/jian/Projects/Big_Lots/Weather/Json_data/forecast/"+Tuesday_StampDate_Str+": 13.json" #1:00 p.m.
...
try:
    ...
    try:
        ...
        json_forecast=json.load(open(weather_forecast_file_13,"r"))
