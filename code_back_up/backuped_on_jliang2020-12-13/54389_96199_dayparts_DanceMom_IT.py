...
import logging
logging.basicConfig(filename='log_dayparts_DanceMom_IT.log', level=logging.INFO)
...
projectname='Lifetime_DanceMom_IT'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/AEN/Dance Mom/IT'

###### make sure the directory file is up to date
personintabpath='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_160101_170611.csv'
