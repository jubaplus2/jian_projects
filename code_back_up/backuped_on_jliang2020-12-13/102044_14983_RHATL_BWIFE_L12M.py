...
"""
import logging
logging.basicConfig(filename='rhatl_bwife_l12m.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0320916','0423323']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/rhatl_bwife_l12m.csv'
