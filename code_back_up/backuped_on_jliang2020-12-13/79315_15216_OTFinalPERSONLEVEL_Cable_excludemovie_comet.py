...
"""
import logging
logging.basicConfig(filename='log_comet_cable_Show.log', level=logging.INFO)
logging.info('otlogcomet')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/MGM/Comet/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/MGM/Comet_cluster.csv'
