...
foldername='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/Sizing'
...
viewershippath='/Users/jubaplus1/Desktop/TV1/Behind the Movement/Sizing/ViewershipClassification.csv'

itshowpath='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/Strangers_showaffnity_1.csv'

otshowpath='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/OT/Broadcast/programmin.csv'

bcastotindicator='T'

otshowpath1 = ['/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/OT/Cable/programmin.csv']

ga1='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/Sizing/walkingdead_AHS_L12M.csv'

ga3='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/Sizing/CW4shows.csv'

ga5='/Users/jubaplus1/Desktop/Aviron Pictures/The Strangers/Sizing/ga5.csv'
...
otshownames1=['AMC  _TALKING DEAD             ','AMC  _WALKING DEAD MARATHON    ','FX   _STRAIN                   ','CW   _ORIGINALS                ','AMC  _FEAR THE WALKING DEAD    ','USA  _SINNER, THE              ','STZP _ASH VS EVIL DEAD 2       ','TRAV _GHOST ADVENTURES         ','SYFY _Z NATION                 ','SYFY _CHANNEL ZERO             ','SPIKE_MIST, THE                ']
...
df['finalsegment']=np.where((df['ga5']==1),'A1',
                   np.where((df['ga1']==1)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['vodsegment']=='LiveOnly'),'A2',
                   np.where((df['ga1']==1)&(df['vodsegment']=='LiveOnly'),'A3',
                   np.where((df['ga1']==1)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['vodsegment']!='LiveOnly'),'A3S',
                   np.where((df['ga3']==1)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['vodsegment']=='LiveOnly'),'A4',
                   np.where((df['ga3']==1)&(df['vodsegment']=='LiveOnly'),'A5',
                   np.where((df['ga3']==1)&(df['MVPD'].isin(['DirecTV','Dish Network']))&(df['vodsegment']!='LiveOnly'),'A5S',
                   np.where((df['ot']>0),'ot','Other'))))))))


print(df[['finalsegment','HHID_PersonID']].groupby('finalsegment').count())

df.to_csv("AudienceSizing_STRANGERS_100_new.csv",index=False)
