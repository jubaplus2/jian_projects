...
"""
import logging
logging.basicConfig(filename='RUNWAY_MOM_L12M.log', level=logging.INFO)
...
Cable_ID=''
Program_ID=['0327885','0345570']
##### update the outputs path and location
finalfiledic='/home/nielsen/MicroSegment/Outputs/Quads/RUNWAY_MOM_L12M.csv'
