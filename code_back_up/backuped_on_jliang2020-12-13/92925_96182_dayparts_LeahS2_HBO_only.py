...
import logging
logging.basicConfig(filename='log_dayparts_Leah_HBO.log', level=logging.INFO)
...
projectname='AEN_LeahS2_HBO'
foldername='/home/nielsen/MicroSegment/Outputs/Dayparts/AEN/Leah_HBO'

###### make sure the directory file is up to date
personintabpath='/home/nielsen/MicroSegment/Outputs/PersonIntab/personintab_140921_150405.csv'
