...
df=pd.read_csv("/Users/jubaplus1/Desktop/Starz - American Gods/IT-HH-ViewershipDayPartsNew.csv",sep="\t")
df.columns
...
hhintab.to_csv("/Users/jubaplus1/Desktop/Starz - American Gods/showaffinityGODS.csv",index=False)
