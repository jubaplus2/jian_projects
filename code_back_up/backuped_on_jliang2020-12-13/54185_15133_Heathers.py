...
ga1='/Users/jubaplus1/Desktop/Paramount/Sizing/spike_l6m.csv'
ga2='/Users/jubaplus1/Desktop/Paramount/Sizing/heathers_a2.csv'
ga3='/Users/jubaplus1/Desktop/Paramount/Sizing/heathers_a3.csv'
...
#a1 file is ga1, A12-24 and W44-54
#a2 file is ga2, A12-24 and W44-54
#a3 file is ga3, A12-24 and W44-54
...
df['finalsegment']=np.where((df['ga1']>0)&(df['AgeGroup']=='A'),'A1',
                           np.where((df['ga2']>0)&(df['AgeGroup']=='A'),'A2',
                           np.where((df['ga3']>0)&(df['AgeGroup']=='A'),'A3',         
                            np.where((df['ot1']>0),'ot','Other'))))

print(df[['finalsegment','HHID_PersonID']].groupby('finalsegment').count())
df.to_csv("AudienceSizing_heathers.csv",index=False)
print(datetime.datetime.now())
