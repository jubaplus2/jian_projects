...
"""
import logging
logging.basicConfig(filename='log_strangers_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/Strangers/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/MicroSegment/Code/Crosstab/Strangers_cluster_new.csv'
...
itlist=['0347743','0338150','0396336','0334600','0397803']
balance_cluster=[3]
occasional_cluster=[2]
