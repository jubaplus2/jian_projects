...
"""
import logging
logging.basicConfig(filename='otlogs_lifetime.log', level=logging.INFO)
logging.info('otlogvivica')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/disk2/OTProject/Lifetime/BlackMagic/Lifetime/'
