...
"""
import logging
logging.basicConfig(filename='log_leah_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Leah/Cable'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Leah/Leah CLUSTER.csv'
...
itlist=['0288526','0366428','0369065','0386134','0410216','0416294','0417593','0394532','0363743']
balance_cluster=[7]
occasional_cluster=[1,8]
