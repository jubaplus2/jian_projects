...
def Smoothie_King_weekly():
    ...
    store_GPS_verified=pd.read_excel("/home/jian/Projects/Smoothie_King/TA/QC_address/SK_store_listed_verified_JL_2019-03-11.xlsx",sheetname="assigned_lat_long",dtype=str)
    ...
    store_list_this_week=store_list_this_week[~store_list_this_week['storenumber'].isin(new_store_list['storenumber'].tolist())]
    ...
    zip_list=zip_list+store_list_this_week['zip'].unique().tolist()
