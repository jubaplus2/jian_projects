...
"""
import logging
logging.basicConfig(filename='log_bfvs6a_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/WEtv/BFV6/Cable/'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/WEtv/BFV6/bfv_cluster.csv'
...
itlist=['0343256','0424948','0354751','0385186','0421121','0423323','0320916','0354816']
balance_cluster=[3]
occasional_cluster=[4]
