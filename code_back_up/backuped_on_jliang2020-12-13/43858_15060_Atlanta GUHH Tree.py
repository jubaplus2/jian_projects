...
#A shows part in itseg_a1, part in otshownames1, PLUS Mary Mary seperate file. any one of the show
#B any show in a2 or a3 or otshownames2
...
itseg_a2=['Totalfreq402099','Totalfreq408558','Totalfreq415098','Totalfreq402100','Totalfreq320916','Totalfreq411078']
itseg_a3=[]
itseg_a4=['']
###otshownames:
otshownames1=['WETV _CUTTING IT: IN THE ATL   ','WETV _MARRIAGE BOOT CAMP: RS   ']
otshownames2=['VH1  _LOVE & HIP HOP HLLYWD 3  ','VH1  _BLACK INK CREW CHICAGO 2 ','LIF  _LITTLE WOMEN ATL         ']
otshownames3=['']
otshownames4=['']
...
ITshows=ITshows[['HHID_PersonID', 'A1', 'A3','ShiftedViewindicatorallprogram']]
ITshows.columns=['HHID_PersonID', 'A1', 'A3','ShiftedViewindicatorallprogram']
...
OTshows2=OTshows2[['HHID_PersonID','vh']]
...
df['finalsegment']=np.where((df['A1']>0)|(df['wetvshow']>0)|(df['mary']>0),'A1',
                            np.where((df['A3']>0)|(df['vh']>0),'A3','Other'))

df.to_csv("AudienceSizing_atl_guhh_tree.csv",index=False)
print(datetime.datetime.now())
