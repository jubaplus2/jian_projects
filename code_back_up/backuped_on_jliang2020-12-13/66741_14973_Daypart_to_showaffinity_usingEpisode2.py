...
inputpath='/Users/jubaplus1/Desktop/GSN/America Says/GSN_AEMellendaypartsnew.csv'
outputpath='/Users/jubaplus1/Desktop/GSN/America Says/'
...
itlist=[352983,241167,241160,149,199379,853308,178580]
startds=[20180108,20180108,20180108,20180108,20180108,20170611,20180108]
endds=[20180408,20180408,20180408,20180408,20180408,20170924,20180408]
...
df['EpisodeName'] = np.where(df['ProgramCode'].isin([352983,241167,241160,147,148,149,199379,853308,178580]),'ep',df['EpisodeName'])
df=df.fillna('na')
...
hhintab.to_csv("/Users/jubaplus1/Desktop/GSN/America Says/AmericaSays_showaffnity.csv",index=False)
