...
"""
import logging
logging.basicConfig(filename='log_model_cable_Show.log', level=logging.INFO)
logging.info('otlog')
...
###change every time. also save code.no space in file name###
###change every time. also save code.no space in file name###
foldername='/home/nielsen/OT/AEN/Supermodel/Cable'

###### make sure the directory file is up to date
clusterpath='/home/nielsen/OT/AEN/Supermodel/SupermodelCluster.csv'
...
itlist=['0398595','0418451','0363715','0418606','0397489','0343256','0415600','0418956','0373656']
balance_cluster=[2]
