...
inputpath='/Users/jubaplus1/Downloads/AEN_Oscardaypartsnew.csv'
outputpath='/Users/jubaplus1/Downloads/'
...
itlist=[81463,400710,400804,401333,283767,374497,422612,393342,393343,96261]
startds=[20160624,20170302,20160313,20160322,20160319,20160601,20170409,20160910,20160702,20160923]
endds=[20160624,20170511,20160403,20161101,20161122,20160824,20170415,20161104,20161112,20170804]
...
df['EpisodeName'] = np.where(df['ProgramCode'].isin([374497,422612,96261,81463]),'ep',df['EpisodeName'])
...
test.to_csv('/Users/jubaplus1/Downloads/Epnames1.csv',index=False)
'''

test=pd.read_csv('/Users/jubaplus1/Downloads/Epnames1.csv',dtype = {'EpisodeName':'str'})
...
hhintab.to_csv("/Users/jubaplus1/Downloads/Oscar_showaffinitynew4.csv",index=False)
