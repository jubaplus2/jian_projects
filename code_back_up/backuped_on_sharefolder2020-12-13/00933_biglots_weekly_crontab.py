...
logging.basicConfig(filename='biglots_weekly_crontab.log', level=logging.INFO)
...
The Big Lots weekly data is received and part of the output is ready. 
...
"""
    ...
    try:
        ...
        print("Error: unable to send email")
print("done biglots_weekly_crontab: "+ str(datetime.datetime.now()))
