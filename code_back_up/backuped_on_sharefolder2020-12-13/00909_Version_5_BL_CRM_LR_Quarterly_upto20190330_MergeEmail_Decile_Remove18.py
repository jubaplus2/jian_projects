...
import gc
import glob
logging.basicConfig(filename='Version_5_BL_CRM_LR_Quarterly_upto20190330_MergeEmail_Decile_Remove18.log', level=logging.INFO)
...
folder_write = '/home/jian/Projects/Big_Lots/Live_Ramp/Quarterly_Update_2019Q2/Investigation_of_differnt_versions/output/Version5_upto20190330_MergeEmail_Decile_Remove18_'+str(datetime.datetime.now().date())+'/'
try:
