...
logging.basicConfig(filename='/home/jian/BL_weekly_crontab/cron_1_weekly_sales_and_weather/biglots_weekly_crontab.log', level=logging.INFO)
...
if not os.path.exists("/home/jian/BiglotsCode/outputs/Output_"+thisweeksdate+"/By_Zip_weather_forecast_for_Saturday_"+Saturday_str+".csv"):
    ...
    print("recentweek",recentweek)
    print("lastweeksdate",lastweeksdate)
...
The data is received and 1 out of the 7 crontabs is finished for this week. Keep an eye on the next.
